...
dataset_id = 'rj-iplanrio.transporte_taxirio'
table_id = 'rj-iplanrio.transporte_taxirio.sua_tabela_tratada'
...
etl = BigQueryETL(credentials_path, dataset_id)
df = etl.query_to_dataframe(query)
etl.load_dataframe_to_bigquery(df, table_id)
